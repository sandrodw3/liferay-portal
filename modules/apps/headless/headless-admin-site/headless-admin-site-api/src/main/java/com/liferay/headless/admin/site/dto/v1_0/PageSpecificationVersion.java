...
@Generated("")
@GraphQLName(
	description = "A versioned snapshot of a site page, captured at a point in time. Stores the full page specification so that the page can be previewed or restored to that state.",
...
public class PageSpecificationVersion implements Serializable {
	...
	@io.swagger.v3.oas.annotations.media.Schema(
		description = "The user who created this version. It is not returned by default. It can be embedded via nestedFields."
	)
	@Valid
	...
	@GraphQLField(description = "The date and time the version was created.")
	@JsonProperty(access = JsonProperty.Access.READ_WRITE)
	...
	@io.swagger.v3.oas.annotations.media.Schema(
		description = "The date and time the version was last modified."
	)
	...
	@io.swagger.v3.oas.annotations.media.Schema(
		description = "The version's external reference code, unique per site."
	)
	...
	@io.swagger.v3.oas.annotations.media.Schema(
		description = "Optional custom name for the version."
	)
	...
	@GraphQLField(description = "Optional custom name for the version.")
	@JsonProperty(access = JsonProperty.Access.READ_WRITE)
	...
	@io.swagger.v3.oas.annotations.media.Schema(
		description = "The full page specification stored in this version. It is not returned by default. It can be embedded via nestedFields. Ignored on create — the server sources the specification from the current draft of the site page."
	)
	@Valid
	...
	@io.swagger.v3.oas.annotations.media.Schema(
		description = "The status of the version. Reflects the lifecycle of the underlying page at the moment the snapshot was taken."
	)
	@JsonGetter("status")
	@Valid
	...
	@io.swagger.v3.oas.annotations.media.Schema(
		description = "The date and time the version's status was set."
	)
	...
	@io.swagger.v3.oas.annotations.media.Schema(
		description = "The monotonically increasing version number of the snapshot."
	)
...
// LIFERAY-REST-BUILDER-HASH:-839526818