...
public class FormRelationshipPageElementDefinitionSerDes {
	...
	public static String toJSON(
		...
		if (formRelationshipPageElementDefinition.getButtonLabel() != null) {
			if (sb.length() > 1) {
				sb.append(", ");
			}
			...
			sb.append(
				String.valueOf(
					formRelationshipPageElementDefinition.getButtonLabel()));
		}

		if (formRelationshipPageElementDefinition.getContentType() != null) {
			if (sb.length() > 1) {
				sb.append(", ");
			}
			...
			sb.append(
				_escape(
					formRelationshipPageElementDefinition.getContentType()));
		...
		protected void setField(
			...
			if (Objects.equals(jsonParserFieldName, "buttonLabel")) {
				if (jsonParserFieldValue != null) {
					formRelationshipPageElementDefinition.setButtonLabel(
				...
				if (jsonParserFieldValue != null) {
					formRelationshipPageElementDefinition.setContentType(
						(String)jsonParserFieldValue);
				}
			}
			else if (Objects.equals(jsonParserFieldName, "cssClasses")) {
...
// LIFERAY-REST-BUILDER-HASH:66324766