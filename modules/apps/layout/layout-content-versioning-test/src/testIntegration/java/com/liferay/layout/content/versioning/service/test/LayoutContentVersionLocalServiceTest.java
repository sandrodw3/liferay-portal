...
public class LayoutContentVersionLocalServiceTest {
	...
	private void _testAddLayoutContentVersionWithNullName() throws Exception {
		LayoutContentVersion layoutContentVersion =
			_layoutContentVersionLocalService.addLayoutContentVersion(
				RandomTestUtil.randomString(), TestPropsValues.getUserId(),
		...
		Assert.assertEquals(
			_draftLayout.getName(LocaleUtil.getSiteDefault()),
			layoutContentVersion.getName(LocaleUtil.getSiteDefault()));
	}
	...
	private void _testAddLayoutContentVersionWithSkipIfUnchanged()
		...
		LayoutContentVersion thirdLayoutContentVersion =
			_layoutContentVersionLocalService.addLayoutContentVersion(
				RandomTestUtil.randomString(), TestPropsValues.getUserId(),
				_draftLayout.getPlid(), RandomTestUtil.randomString(),
				otherData, WorkflowConstants.STATUS_APPROVED, true);
		LayoutContentVersion fourthLayoutContentVersion =
			_layoutContentVersionLocalService.addLayoutContentVersion(
				RandomTestUtil.randomString(), TestPropsValues.getUserId(),
				_draftLayout.getPlid(), RandomTestUtil.randomString(),
				otherData, WorkflowConstants.STATUS_APPROVED, true);
		...
		Assert.assertEquals(
			thirdLayoutContentVersion.getLayoutContentVersionId(),
