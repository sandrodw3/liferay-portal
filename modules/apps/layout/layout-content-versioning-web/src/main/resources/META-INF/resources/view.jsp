...
<%
LayoutContentVersioningDisplayContext layoutContentVersioningDisplayContext = (LayoutContentVersioningDisplayContext)request.getAttribute(LayoutContentVersioningWebKeys.LAYOUT_CONTENT_VERSIONING_DISPLAY_CONTEXT);

Map<String, Object> context = layoutContentVersioningDisplayContext.getContext();
