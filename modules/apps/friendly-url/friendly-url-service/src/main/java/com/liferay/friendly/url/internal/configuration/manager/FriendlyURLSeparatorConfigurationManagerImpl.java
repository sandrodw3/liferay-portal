...
public class FriendlyURLSeparatorConfigurationManagerImpl
	...
	@Override
	public String getURLSeparators(long companyId)
		...
		return friendlyURLSeparatorCompanyConfiguration.urlSeparators();
	}

	@Override
	public void updateFriendlyURLSeparatorCompanyConfiguration(
			long companyId, String urlSeparators)
		throws ConfigurationException {

		_configurationProvider.saveCompanyConfiguration(
			FriendlyURLSeparatorCompanyConfiguration.class, companyId,
			HashMapDictionaryBuilder.<String, Object>put(
				"urlSeparators", urlSeparators
			).build());
	}
