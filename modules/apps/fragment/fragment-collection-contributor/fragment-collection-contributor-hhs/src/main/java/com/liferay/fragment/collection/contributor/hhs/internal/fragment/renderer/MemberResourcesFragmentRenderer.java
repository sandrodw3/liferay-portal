...
public class MemberResourcesFragmentRenderer implements FragmentRenderer {
	...
	public String getLabel(Locale locale) {
		return _language.get(locale, "Member Resources");
	}
	...
	public void render(
		...
		try {
			...
			componentTag.setModule(
				"{MemberResources} from fragment-collection-contributor-hhs");
	...
	private static final Log _log = LogFactoryUtil.getLog(
		MemberResourcesFragmentRenderer.class);
